...
{
    public partial class MainTVDashboard : Form
    {
        ...
        private void getTVReportInfo()
        {
            ...
            queryGetProgramInfo.Append("select * from programs_info where program_type = 'TV' order by program_name asc");
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    listItems[i].GlobalMouseClick += new GlobalMouseClickEventHander(this.MainTVsButton_Click);
                }
            }
        }
        ...
        private void MainTVsButton_Click(object sender, EventArgs e)
        {
            ToolsItemButton obj;
