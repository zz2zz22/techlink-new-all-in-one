...
{
    public partial class BirdHuntingPlayGame : Form
    {
        ...
        public BirdHuntingPlayGame(Guns gun, Birds bird)
        {
            InitializeComponent();
        ...
        public void PlayGunSound()
        {
            new System.Threading.Thread(() =>
            {
                if (SelectedGun == Guns.Shotgun)
                {
                    FileStream gunSoundFile = new FileStream(Environment.CurrentDirectory + @"\Resources\Shotgun-Fire.wav", FileMode.Open, FileAccess.Read);
                    new SoundPlayer(gunSoundFile).Play();
                }
                else if (SelectedGun == Guns.M1Grand)
                {
                    FileStream gunSoundFile = new FileStream(Environment.CurrentDirectory + @"\Resources\M1Garand-Fire.wav", FileMode.Open, FileAccess.Read);
                    new SoundPlayer(gunSoundFile).Play();
                }
                else if (SelectedGun == Guns.Glock)
                {
                    FileStream gunSoundFile = new FileStream(Environment.CurrentDirectory + @"\Resources\Glock-Gun-Fire.wav", FileMode.Open, FileAccess.Read);
                    new SoundPlayer(gunSoundFile).Play();
                }
            }).Start();
        }
        ...
        public void PlayBirdHitSound()
        {
            new System.Threading.Thread(() =>
            {
                FileStream gunSoundFile = new FileStream(Environment.CurrentDirectory + @"\Resources\bird-hit.wav", FileMode.Open, FileAccess.Read);
                new SoundPlayer(gunSoundFile).Play();
            }).Start();
        ...
        public void PlayForestBirdsSound()
        {
            new System.Threading.Thread(() =>
            {
                FileStream forestBirdsSoundFile = new FileStream(Environment.CurrentDirectory + @"\Resources\forest-and-birds.wav", FileMode.Open, FileAccess.Read);
        ...
        private void BirdHuntingPlayGame_Load(object sender, EventArgs e)
        {
            AddNewBird("", "");
            AddNewBird("", "");
            AddNewBird("", "");
        ...
        private void BirdHuntingPlayGame_Click(object sender, EventArgs e)
        {
            if (GameStatus == GameStatus.Continue)
            {
                PlayGunSound();
