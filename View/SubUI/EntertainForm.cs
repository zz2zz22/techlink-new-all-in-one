...
{
    public partial class EntertainForm : Form
    {
        private Type[] typelist;
        public EntertainForm()
        {
            InitializeComponent();
        }

        private void getEntertainToolInfo()
        {
            ...
            queryGetProgramInfo.Append("select * from programs_info where program_type = 'game' order by program_name asc");
        ...
        private void EntertainForm_Load(object sender, EventArgs e)
        {
            getEntertainToolInfo();
