...
{
    public partial class SubToolsView : Form
    {
        ...
        private void getSubToolInfo()
        {
            ...
            queryGetProgramInfo.Append("select * from programs_info where program_type = 'sub' order by program_name asc");
        ...
        private void SubToolsView_Load(object sender, EventArgs e)
        {
            getSubToolInfo();
